...
function RichardsonSmoother(M::Gridap.Algebra.LinearSolver,
  ...
  RichardsonSmoother{A,B}(M,num_smooth_steps,damping_factor)
end
...
function Gridap.Algebra.symbolic_setup(smoother::RichardsonSmoother,mat::AbstractMatrix)
  ...
  RichardsonSmootherSymbolicSetup(smoother,Mss)
end
...
function Gridap.Algebra.numerical_setup(ss::RichardsonSmootherSymbolicSetup,
  ...
  RichardsonSmootherNumericalSetup(ss.smoother,A,Adx,dx,Mns)
end
...
function Gridap.Algebra.solve!(
  x::AbstractVector,ns::RichardsonSmootherNumericalSetup,r::AbstractVector)
